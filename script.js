document.addEventListener('DOMContentLoaded', function() {
 ...
 function updateClock() {
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d120638.0645226495!2d73.045437!3d18.989401!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7e8c71cc169b9%3A0x629b350415a77c38!2sPanvel%2C%20Navi%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1716382000000!5m2!1sen!2sin" width="100%" height="300" style="border:0; border-radius:5px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <ul style="max-height: 250px; overflow-y: auto;">
   ...
   <li><span>telemetry_history.bak</span> <span style="color:#666">56.2 MB</span></li>
      ...
      'Calendar': `<h3>SCHEDULER / CALENDAR</h3>
           ...
           <input type="date" id="cal-date" min="2026-01-01" max="2100-12-31" style="width:100%; background:rgba(0,0,0,0.5); color:var(--neon-blue); border:1px solid var(--neon-blue); padding:8px; margin-bottom:15px; font-family:'Syncopate', sans-serif; box-sizing: border-box;">
           <label>New Reminder:</label>
           <div style="display:flex; gap:10px; margin-bottom:15px;">
               <input type="text" id="rem-text" placeholder="e.g. Oil change..." style="flex:1; background:rgba(0,0,0,0.5); color:#fff; border:1px solid var(--neon-red); padding:8px;">
               <button class="flash-btn" id="add-rem-btn" style="width:auto; padding:5px 20px;">ADD</button>
           </div>
     <ul id="reminder-list" style="max-height:120px; overflow-y:auto; border:1px solid rgba(255,255,255,0.1); padding:5px;">
          <li><span>2026-09-15: Track day at Buddh Circuit</span> <button class="del-rem" style="background:none;border:none;color:var(--neon-red);cursor:none;">X</button></li>
           </ul>`
   };
    ...
    if(e.target.id === 'add-rem-btn') {
          ...
          if(dateVal && textVal) {
             let list = document.getElementById('reminder-list');
               ...
               li.innerHTML = `<span>${dateVal}: ${textVal}</span> <button class="del-rem" style="background:none;border:none;color:var(--neon-red);cursor:none;">X</button>`;
              list.appendChild(li);
             document.getElementById('rem-text').value = '';
           }
       }
  
       if(e.target.classList.contains('del-rem')) {
